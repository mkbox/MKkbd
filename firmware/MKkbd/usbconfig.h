 ...
 */
#define USB_CFG_VENDOR_NAME     'M', 'K', 'B', 'o', 'x'
...
#define USB_CFG_INTERFACE_SUBCLASS  0x01      /* no boot interface */
#define USB_CFG_INTERFACE_PROTOCOL  0x01       /* no protocol */
/* See USB specification if you want to conform to an existing device class or
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    68  /* total length of report descriptor */
